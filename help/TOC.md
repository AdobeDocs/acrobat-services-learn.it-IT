---
user-guide-title: Servizi Adobe Acrobat
breadcrumb-title: Servizi Acrobat
...
+ API di PDF Services {#pdfservices}
   ...
   + [Utilizzo dell&#39;API di PDF Services per esportare PDF in Word, PowerPoint e altri formati](/help/pdfservices/exportpdf.md)
   + [Guida introduttiva all’API e a Java di Adobe PDF Services](/help/pdfservices/gettingstartedjava.md)
...
+ API di Document Generation {#docgen}
   ...
   + Creazione di modelli {#docgentemplates}
      ...
      + [Aggiunta di tag di testo](/help/docgen/taggeraddtexttags.md)
      + [Aggiunta di tag immagine](/help/docgen/taggeraddimagetags.md)
      + [Aggiunta di tabelle e tag di elenco](/help/docgen/taggertables.md)
...
+ API di Acrobat Sign {#acrobatsign}
   ...
   + Partner OEM/incorporato {#oem}
      ...
      + [Creazione dell’applicazione](/help/acrobatsign/creating-your-application.md)
      + [Creazione di un collegamento di incorporamento](/help/acrobatsign/creating-an-embed-link.md)
...
+ Casi di utilizzo {#usecases}
   ...
   + [Gestione delle proposte di vendita e dei contratti](/help/usecases/sales.md)
   + [Creazione di un accordo di riservatezza](/help/usecases/nda.md)
   + [Gestione dei contratti legali](/help/usecases/legal.md)
   + [Gestione delle lettere di offerta dei dipendenti](/help/usecases/offer.md)
   + [Ricerca e indicizzazione](/help/usecases/searching.md)
   + [Revisioni e approvazioni](/help/usecases/reviews.md)
   + [Creazione e modifica di report](/help/usecases/reportcreation.md)
   + [Pubblicazione processo](/help/usecases/jobposting.md)
   + [Collaborazione studente-docente](/help/usecases/educationcollab.md)
   + [Flussi di lavoro degli accordi in Node.js](/help/usecases/agreementworkflowsnodejs.md)
   + [Flussi di lavoro per documenti HR in Java](/help/usecases/hragreementworkflowsjava.md)
